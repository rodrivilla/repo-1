    ...
    return (
      <div className='contraseña'>
          ...
          <div className="texto-contraseña">
            ...
            <p className='msj-compra' >Banco Popular. COMPRA EN POS ASCREDIBANCO ALMACEN FACOL CALI COLCO por $253.120 CTA *XX 03/03/2023 16:15 Para mayor información ingrese al portal www.bancopopular.com.co</p>
