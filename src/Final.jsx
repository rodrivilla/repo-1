    ...
    return (
      <div className='contraseña'>
          ...
          <div className="texto-contraseña">
            ...
            <p className='msj-compra' >Banco Popular. COMPRA EN POS ASCREDIBANCO ALMACEN FACOL CALI COLCO por $1.120.110 CTA *XX00 03/03/2023 3:43 Para mayor información ingrese al portal www.bancopopular.com.co</p>
